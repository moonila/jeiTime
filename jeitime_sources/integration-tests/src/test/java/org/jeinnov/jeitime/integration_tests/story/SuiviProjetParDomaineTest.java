...
public class SuiviProjetParDomaineTest extends AbstractIntegrationCase {

	public void test_SuiviProjet_ParDomaine() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Gestion de projet");
		selenium.click("//div[@id='sidebar']/div[3]/ul/li[1]/ul");
		...
		selenium.click("link=Par Domaine et par période");
		selenium.waitForPageToLoad("30000");
