...
public class SuiviProjetParThematiqueTest extends AbstractIntegrationCase {

	public void test_SuiviProjet_ParThematique() throws Exception {
                //Connection
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=prenom_coll2 nom_coll");
		selenium.waitForPageToLoad("30000");
		...
		selenium.click("link=Par Thématique et par période");
		selenium.waitForPageToLoad("30000");
		...
		selenium.click("link=Oui");
		selenium.waitForPageToLoad("30000");
                //Supprimer le projet et de son type
		selenium.click("link=Gestion de projet");
		selenium.click("link=Consultation Projet");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Supprimer");
