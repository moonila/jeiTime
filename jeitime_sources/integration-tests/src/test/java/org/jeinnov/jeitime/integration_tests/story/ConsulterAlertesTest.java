...
public class ConsulterAlertesTest extends AbstractIntegrationCase {

	public void test_ConsulterAlertes() throws Exception {
                //Connection
		...
		selenium.waitForPageToLoad("30000");
                //Coonsulter les alertes
		selenium.click("link=Consulter les alertes annuelles");
		selenium.waitForPageToLoad("30000");
		selenium.type("mainAnnee_alerteBean_annee", "2010");
		selenium.click("//input[@value='Soumettre']");
		selenium.waitForPageToLoad("30000");
		verifyTrue(selenium.isTextPresent("5.0"));
		selenium.click("link=Consulter les alertes mensuelles");
		selenium.waitForPageToLoad("30000");
		selenium.select("mainAnnee_alerteBean_mois", "label=Juillet");
		selenium.type("mainAnnee_alerteBean_annee", "2010");
		selenium.click("//input[@value='Soumettre']");
		selenium.waitForPageToLoad("30000");
		verifyTrue(selenium.isTextPresent("5.0"));
		verifyTrue(selenium.isTextPresent("+ 5.0"));
		selenium.click("link=Consulter les alertes");
		selenium.click("link=Consulter les alertes hebdomadaires");
		selenium.waitForPageToLoad("30000");
		selenium.type("mainAnnee_alerteBean_dateDeb", "05/07/2010");
