...
public class CreerSupprAffecterRessourceDupuisOngletTest extends AbstractIntegrationCase {

	public void test_Creer_Suppr_AffecterRessource_DupuisOnglet() throws Exception {
                //Connection
		...
		selenium.click("link=Oui");
		selenium.waitForPageToLoad("30000");
                //Suppprimer le type de tache et son groupe
//		selenium.click("link=Paramétrage");
//		selenium.click("link=Gestion des Types de Tâches");
//		selenium.waitForPageToLoad("30000");
//		selenium.click("link=supprimer");
